...
public class ZbranTVTController implements Initializable {
    ...
    @FXML
    private ComboBox<ZbranTVTLogika.Druh> druhComboBox;
    @FXML
    private ComboBox<ZbranTVTLogika.Drzeni> drzeniComboBox;
    @FXML
    ...
    @FXML
    private ComboBox<ZbranTVTLogika.Delka> delkaComboBox;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        // naplnění comboboxů
        druhComboBox.getItems().setAll(Arrays.asList(ZbranTVTLogika.Druh.values()));
        drzeniComboBox.getItems().setAll(Arrays.asList(ZbranTVTLogika.Drzeni.values()));
